...
<body>
    ...
    <div class="container">
        ...
        $sql = " SELECT * FROM tempbuy where username = '$un' ";
            ...
            <div class="container_1">
                <form method="post">
                    ...
                    <div class="container_1_btn">
                        <input type="submit" value="⛔" class="removebtn" name="remove_buy" style="min-width:1vw" ;>
                ...
                <form id="login-form" method="post">
                    ...
                    <p>
                        ...
                        <p>
                            ...
                            <p>
                                <input class="placeord" type="submit" id="login" value="PLACE ORDER " name="mainbuy_buy">
                            </p>
                <?php
                    }
                ?>
